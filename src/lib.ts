...
function fetchRandomQuestion(): string {
  const questions = [
...
export function handleStart(roomArr: Array<room>, socket: any, cb: Function, io: any): void {
 ...
 */
export function handleDisconnect(disconnectedId: string, roomArr: Array<room>, io: any) {
  for (let i = 0; i < roomArr.length; i++) {
